...
<div class="min-h-screen bg-white pt-5 font-sans">
    ...
    >
        <Button
            variant="ghost"
            onclick={() =>
                goto(`/app/lecturer/class/${data.classId}/topic-list`)}
    ...
    <div class="px-6 py-8 space-y-6">
        ...
        >
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    View submitted topic information, group details, and review
                    result.
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 2xl:grid-cols-12">
            ...
            <!-- Review information -->
            <div
                class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm 2xl:col-span-7"
            >
                <div class="border-b border-gray-100 bg-gray-50/60 px-6 py-4">
                    <p
                        class="text-xs font-bold uppercase tracking-widest text-gray-400"
                ...
                <div
                    class="grid grid-cols-1 gap-6 px-6 py-5 xl:grid-cols-[240px_220px_1fr]"
                >
                    <div>
                    ...
                    <div>
                        ...
                        <p
                            class={`text-sm ${topic.reviewedAt ? "text-gray-900" : "italic text-gray-400"}`}
                        >
                            {formatDate(topic.reviewedAt)}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        >
                            <p
                                class={`text-sm leading-relaxed ${topic.reviewFeedback ? "text-gray-900" : "italic text-gray-400"}`}
                            >
