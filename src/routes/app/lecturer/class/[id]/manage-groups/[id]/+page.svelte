...
<div class="min-h-screen pt-25 bg-stone-50 px-6 py-10">
    <div class="flex items-center justify-between mb-5 max-w-4xl mx-auto">
        <a
            class="flex gap-2 w-fit items-center text-xl hover:bg-amber-200 rounded-2xl px-2 py-1 transition-all duration-200"
            href={`/app/lecturer/class/${classId}/manage-groups`}
        >
            <ArrowLeftIcon />Back to Groups
        </a>
        ...
        >
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <div class="flex items-center gap-2 text-sm text-stone-600">
                    ...
                    />
                    <div>
                        <p class="text-xs text-stone-400">Majors</p>
                        <p class="font-medium text-stone-800">{totalMajors}</p>
                    </div>
                </div>
            </div>
        </div>
