<script lang="ts">
    ...
    const initValues = () => ({
        ...
        yearsOfExperience:
            user.mentor?.yearsOfExperience != null
                ? String(user.mentor.yearsOfExperience)
                : "",
    });
    ...
    let mentorInformations = $derived([
        ...
        {
            label: "Company",
            value: user.mentor?.currentCompany,
            icon: BriefcaseIcon,
            editable: true,
            key: "currentCompany" as keyof typeof editableValues,
            multiline: false,
        },
        {
            label: "Field of Work",
            value: user.mentor?.fieldOfWork,
            icon: WrenchIcon,
            editable: true,
            key: "fieldOfWork" as keyof typeof editableValues,
            multiline: false,
        },
        {
            ...
            icon: ClockIcon,
            editable: true,
            key: "yearsOfExperience" as keyof typeof editableValues,
            multiline: false,
            inputType: "number",
        },
        {
            label: "Biography",
            value: user.mentor?.biography,
            icon: FileTextIcon,
            editable: true,
            key: "biography" as keyof typeof editableValues,
            multiline: true,
        },
    ]);
    ...
    <div class="flex flex-col gap-3" class:col-span-full={o.multiline}>
        <div class="flex gap-3 w-full">
            ...
            <div class="w-full">
                ...
                {:else if o.multiline}
                    <div
                        class="w-full rounded-md border border-stone-200 bg-stone-50 px-3 py-2 text-[15px] font-bold text-stone-800 min-h-[80px] whitespace-pre-wrap"
                    >
                        {displayValue(o) || "—"}
                    </div>
                {:else}
