...
<div class="min-h-screen bg-white font-sans">
        ...
        <div class="flex items-start gap-5">
            ...
            <div class="min-w-0 flex-1">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <Badge class="rounded-full border border-gray-200 bg-white px-2.5 py-0.5 text-xs font-semibold text-gray-500">
    ...
    <div class="px-8 py-8 space-y-10">
        ...
        <section class="space-y-4">
            ...
            <div class="space-y-4">
                <div class="rounded-xl border border-gray-200 bg-gray-50/60 px-6 py-5">
                    <p class="mb-2 text-xs font-bold uppercase tracking-widest text-gray-500">
                        Description
                    </p>
        ...
        <section class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                <!-- Submitted By -->
                <div class="rounded-xl border border-gray-200 bg-gray-50/60 px-6 py-5 space-y-4">
                    <p class="text-xs font-bold uppercase tracking-widest text-gray-500">
                        Submitted By
                    </p>
                    <div class="flex items-center gap-3">
                        <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-amber-100 font-bold text-amber-700 text-lg">
        ...
        <section class="space-y-4">
            ...
            <div class="rounded-xl border border-gray-200 bg-gray-50/60 px-6 py-5 space-y-5">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class={`text-base font-medium ${topic.reviewedAt ? "text-gray-900" : "italic text-gray-400"}`}>
                ...
                <div>
                    ...
                    <div class="rounded-xl border border-gray-100 bg-white px-5 py-4">
                        <p class={`text-base leading-relaxed whitespace-pre-wrap ${topic.reviewFeedback ? "text-gray-800" : "italic text-gray-400"}`}>
                            {topic.reviewFeedback ?? "No feedback provided yet."}
                        </p>
                    </div>
                </div>
            </div>
